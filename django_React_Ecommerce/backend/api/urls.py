...
urlpatterns = [
    # userauths Endpoints or URLs include login register reset-password
    ...
    path('vendor-create-products/', vendor_views.ProductCreateView.as_view()),
    path('vendor-update-products/<vendor_id>/<product_pid>/', vendor_views.ProductUpdateView.as_view()),
    path('vendor-delete-products/<vendor_id>/<product_pid>/', vendor_views.ProductDeleteAPIView.as_view()),
