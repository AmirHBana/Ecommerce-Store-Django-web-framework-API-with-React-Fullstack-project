# Generated by Django 4.2.9 on 2024-05-17 17:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefghijklmnopqrstuvwxyz1234567890', length=10, max_length=10, prefix='', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tax_fee', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('total', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('countery', models.CharField(blank=True, max_length=100, null=True)),
