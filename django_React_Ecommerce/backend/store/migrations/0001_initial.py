# Generated by Django 4.2.9 on 2024-05-14 17:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefghijklmnopqrstuvwxyz1234567890', length=10, max_length=25, prefix='', unique=True)),
                ('slug', models.SlugField(unique=True)),
