...
from store.models import (Category, Product, Gallery, Size, Color, Cart, CartOrder, CartOrderItem, ProductFaq,
                          Review, WishList, Notification, Coupon, Specification)
...
class ReviewSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Review
        fields = ['id', 'review', 'rating', 'user','reply', 'product', 'profile', 'date']
