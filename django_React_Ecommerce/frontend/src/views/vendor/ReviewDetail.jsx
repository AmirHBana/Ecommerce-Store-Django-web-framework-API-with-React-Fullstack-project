                                        ...
                                        <div className="card-body m-3">
                                            <div className="row">
                                                ...
                                                <div className="col-lg-8">
                                                    ...
                                                    <div className=" mt-3">
                                                        <form className="d-flex" onSubmit={handleReplySubmit}>
                                                            <input value={updateReview.reply} name='reply' onChange={handleReplyChange} type="text" placeholder="Write your Reply"
