...
function UpdateProduct() {
    ...
    useEffect(() => {
        apiInstance.get(`vendor-update-products/${userData?.vendor_id}/${param?.pid}/`).then((res) => {
            setProduct(res.data)
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await apiInstance.patch(`vendor-update-products/${userData?.vendor_id}/${param?.pid}/`, formdata, {
            headers: {
                                                        ...
                                                        {gallery?.map((item, index) => (
                                                            <div className="row text-dark" key={index}>
                                                                <div className="col-lg-6 mb-2">
                                                                    ...
                                                                    {/*Default image were there is no image selected.*/}
                                                                    {!item.image &&
                                                                        <img
                                                                            src={defaultImage}
                                                                            alt=''
