...
function ProductDetail() {
    ...
    const handleAddToCart = async () => {
        try {
            ...
            // make post request to the cart api view
    ...
    const fetchReviewData = async () => {
        // we can do a simple job like under in two way  1 with if   and another way with ?
        if (product !== null) {
                                ...
                                <div>
                                    ...
                                    <div>
                                            ...
                                            <div className="col-md-6 mb-4">
                                                <div className="form-outline">
                                                    <label className="form-label"
                                                           htmlFor="typeNumber"><b>Quantity</b></label>
                                                    <input
                                                        type="number"
                                                        id="typeNumber"
                                                        ...
                                                        <div className='d-flex'>
                                                            {size?.map((s, index) => (
                                                                <div key={index} className='me-2'>
                                                                    <input type="hidden" className='size_name'
                                                                           value={s.name}/>
                                                                    <button
                                                                        className='btn btn-secondary m-1 size_button'
                                                                        onClick={handleSizeButtonClick}>{s.name}</button>
                                                                </div>
                                                            ))}
                                                        </div>
                                                    </div>
                                                ...
                                                <>
                                                    ...
                                                    <div className="col-md-6 mb-4">
                                                        <div className='d-flex'>
                                                            {color?.map((c, index) => (
                                                                <div key={index}>
                                                                    <input type="hidden" className='color_name'
                                                                           value={c.name}/>
                                                                    <input type="hidden" className='color_image'
                                                                           value={1}/>
                                                                    <button className='btn p-3 m-1 color_button'
                                                                            type='button'
                                                                            onClick={handleColorButtonClick}
                                                                            style={{background: `${c.color_code}`}}></button>
                                                                </div>
                                                            ))}
                                                        </div>
                                                    </div>
                                        ...
                                        <button type="button" className="btn btn-primary btn-rounded me-2" onClick={handleAddToCart}>
                                            ...
                                            <button href="#!" type="button" className="btn btn-danger btn-floating"
                                                    data-mdb-toggle="tooltip" title="Add to wishlist">
