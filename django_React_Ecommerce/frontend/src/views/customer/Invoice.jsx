            ...
            <div>
                <>
                    <div className="row d-flex justify-content-center p-2">
                        <div
                            className="receipt-main col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                                        ...
                                        <div className="col-xs-12 col-sm-12 col-md-12 text-left">
                                            <div className="receipt-right">
                                                <h5 className="margin-top-10">
                                                    AmirHBana<span className="text-warning">.</span>
                                                </h5>
                                                <p>
                                                    <i className="fa fa-phone"/> +98 9134460636
                                                </p>
                                                <p>
                                                    <i className="fa fa-envelope"/> amir666arrow@gmail.com
                                                </p>
                                                <p>
                                                    <i className="fa fa-location-arrow"/> IRAN, YAZD
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <table className="table table-bordered">
                                    ...
                                    {orderItems?.map((o, index) => (
                                        <tr>
                                            ...
                                            <td className="col-md-2 text-danger">
                                                <b>${o.saved}</b>
                                            </td>
                                        </tr>
                                    ))}
